                    ...
                    @foreach ($reports as $report)
                        <tr>
                            ...
                            <td>
                                ...
                                <!-- Delete button -->
                                {{-- <a href="{{ route('admin.reports.download', ['id' => $report->id]) }}" class="download"> --}}
                                <a class="download">
                                    <i class="material-icons" data-toggle="tooltip" title="Download">cloud_download</i>
                                </a>
                            </td>
                        </tr>
                        ...
                        <div id="editReportModal-{{ $report->id }}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="{{ route('admin.doctors.patients.reports.update', ['id' => $report->id]) }}" method="POST" >
                                        @csrf
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>Patient</label>
                                                <input type="text" class="form-control" value="{{ $report->image->patient->name }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Prediction</label>
                                                <input type="text" class="form-control" name="prediction" value="{{ $report->prediction }}" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label>Result Time</label>
                                                <input type="text" class="form-control" name="result_time" value="{{ $report->result_time }}" readonly>
                                            </div>
                                            <div class="form-group">
